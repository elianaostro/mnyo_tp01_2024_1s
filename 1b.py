...
def main():
    ...
    for num_points in num_points_list:
        ...
        x1, x2, z = generate_equiespaced_points(num_points)
        x1_chebyshev, x2_chebyshev, z_chebyshev = generate_chebyshev_points(num_points)
