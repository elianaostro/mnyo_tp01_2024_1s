...
def plot_interpolation(X1_new, X2_new, Z_new, kind):
    ...
    ax_interp.set_title(f'Interpolacion {kind}')
    plt.show()
...
def main():
    ...
    plot_ground_truth(x1, x2, z)
    plot_interpolation(x1_cubic, x2_cubic, z_new_cubic, 'Spline Cubico')
    plot_error(x1_cubic, x2_cubic, error_cubic, 'Spline Cubico')

    plot_interpolation(x1_chebyshev_cubic, x2_chebyshev_cubic, z_chebyshev_cubic, 'Spline Cubico Chebyshev')
    plot_error(x1_chebyshev_cubic, x2_chebyshev_cubic, error_chebyshev, 'Spline Cubico Chebyshev')

    plot_interpolation(x1_linear, x2_linear, z_new_linear, 'Spline Lineal')
    plot_error(x1_linear, x2_linear, error_linear, 'Spline Lineal')

    plot_interpolation(x1_chebyshev_linear, x2_chebyshev_linear, z_chebyshev_linear, 'Spline Lineal Chebyshev')
    plot_error(x1_chebyshev_linear, x2_chebyshev_linear, error_chebyshev_linear, 'Spline Lineal Chebyshev')
